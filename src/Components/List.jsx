        ...
        <div className="container mx-auto flex flex-col items-center justify-between p-4 rounded-xl shadow-md">
            ...
            <div className="flex flex-col w-full items-center justify-between md:flex-row">
                ...
                <div className="flex flex-row items-center justify-between">
                    ...
                    <button
                        type="button"
                        className="bg-gray-500 hover:bg-gray-700 text-white py-1 px-2 m-2 rounded-full"
                        value="surname"
                        ...
                        <div className="flex flex-row justify-between p-1">
                            {!account.blocked ? (
                                <>
                                    <button
                                        type="button"
                                        className="bg-red-500 hover:bg-red-700 text-white font-bold p-2 m-1 rounded"
                                        onClick={() => block(account.id)}
                                    >
                                        BLOCK
                                    </button>
                                    <button
                                        type="button"
                                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold p-2 m-1 rounded"
                                ...
                                <>
                                    ...
                                    <button
                                        type="button"
                                        className="bg-gray-500 hover:bg-gray-700 text-white font-bold p-2 m-1 rounded"
                                        onClick={() => setAddModal(account)}
                                    >
                                        ADD
                                    </button>
